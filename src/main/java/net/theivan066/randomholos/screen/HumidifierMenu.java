...
public class HumidifierMenu extends AbstractContainerMenu {
    ...
    public HumidifierMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.HUMIDIFIER_MENU.get(), pContainerId);
        checkContainerSize(inv, 2);
        blockEntity = ((HumidifierBlockEntity) entity);
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 2;  //number of slots
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.HUMIDIFIER.get());
    }
