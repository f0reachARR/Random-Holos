package net.theivan066.randomholos.worldgen.portal;
...
public class KakuriyoTeleporter implements ITeleporter {
    ...
    public KakuriyoTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.KAKURIYO_PORTAL.get().defaultBlockState(), 3);
            }
        }
