    ...
    private static final Map<RobocoVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(RobocoVariant.class), map -> {
                map.put(RobocoVariant.DEFAULT,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/roboco.png"));
                map.put(RobocoVariant.HOODIE_ROBOCO,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/hoodie_roboco.png"));
                map.put(RobocoVariant.SPORT_ROBOCO,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/sport_roboco.png"));
                map.put(RobocoVariant.COAT_ROBOCO,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/coat_roboco.png"));
                map.put(RobocoVariant.NIGHTY_DRESS_ROBOCO,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/nighty_dress_roboco.png"));
                map.put(RobocoVariant.SUMMER_ROBOCO,
                        new ResourceLocation(RandomHolos.MOD_ID, "textures/entity/roboco/summer_roboco.png"));
            });
