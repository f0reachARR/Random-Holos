...
public class MikopModel<T extends MikopEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = mikop.addOrReplaceChild("head", CubeListBuilder.create().texOffs(2, 2).addBox(-7.0F, -1.0F, -7.0F, 14.0F, 10.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(13, 13).addBox(-6.0F, 0.0F, 5.0F, 12.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(13, 13).addBox(-6.0F, -1.0F, 5.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(13, 13).addBox(-6.0F, 8.0F, 4.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(13, 13).addBox(6.0F, 0.0F, 5.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(13, 13).addBox(-7.0F, 0.0F, 5.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(62, 13).addBox(-0.5F, 5.0F, -8.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(61, 61).addBox(-6.0F, 0.0F, -8.0F, 12.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(60, 60).addBox(-6.0F, -1.0F, -8.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(60, 60).addBox(-6.0F, 8.0F, -8.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(60, 60).addBox(-7.0F, 0.0F, -8.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(60, 60).addBox(6.0F, 0.0F, -8.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(42, 37).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(42, 37).addBox(6.0F, -2.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(42, 37).addBox(-7.0F, -2.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(51, 46).addBox(-6.0F, -2.0F, -7.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(51, 46).addBox(-6.0F, -2.0F, 4.0F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(-8.0F, 0.0F, -6.0F, 1.0F, 8.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(-8.0F, -1.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(-8.0F, 8.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(59, 24).addBox(-8.0F, 0.0F, -7.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(59, 24).addBox(-8.0F, 0.0F, 4.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(46, 0).addBox(-7.0F, 9.0F, -7.0F, 14.0F, 1.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(0, 47).addBox(-6.5F, 10.0F, -6.5F, 13.0F, 1.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(7.0F, -1.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(7.0F, 8.0F, -6.0F, 1.0F, 1.0F, 10.0F, new CubeDeformation(0.0F))
				.texOffs(59, 24).addBox(7.0F, 0.0F, -7.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(59, 24).addBox(7.0F, 0.0F, 4.0F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(50, 15).addBox(7.0F, 0.0F, -6.0F, 1.0F, 8.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -24.0F, 0.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(62, 13).addBox(0.0F, -1.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, -8.0F, 0.0F, 0.0F, 0.2618F));

		PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(62, 13).addBox(-2.0F, -1.0F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, -8.0F, 0.0F, 0.0F, -0.2618F));
		...
		PartDefinition ears = head.addOrReplaceChild("ears", CubeListBuilder.create().texOffs(4, 88).addBox(-2.0F, -4.0F, -1.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(5, 95).mirror().addBox(-2.0F, -4.0F, -1.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(7.0F, 1.0F, 0.0F));

		PartDefinition body = mikop.addOrReplaceChild("body", CubeListBuilder.create().texOffs(2, 27).addBox(-6.0F, 12.0F, -6.0F, 12.0F, 8.0F, 10.0F, new CubeDeformation(0.0F))
		...
		PartDefinition legs = mikop.addOrReplaceChild("legs", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
