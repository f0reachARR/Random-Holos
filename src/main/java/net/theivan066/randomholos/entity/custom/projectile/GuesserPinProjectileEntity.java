...
public class GuesserPinProjectileEntity extends ThrowableItemProjectile {
    ...
    protected void onHitEntity(EntityHitResult pResult) {
        if (pResult.getEntity() instanceof LivingEntity entity) {
            ...
            MobEffectInstance effect = entity.getEffect(ModEffects.ZERO_GUESSER_EFFECT);
            ...
            entity.addEffect(new MobEffectInstance(ModEffects.ZERO_GUESSER_EFFECT, 200, lvl + 1));
        }
