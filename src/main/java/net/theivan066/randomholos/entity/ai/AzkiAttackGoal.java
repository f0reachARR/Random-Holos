...
public class AzkiAttackGoal extends RangedAttackGoal {
    ...
    public AzkiAttackGoal(RangedAttackMob pRangedAttackMob, double pSpeedModifier, int pAttackInterval, float pAttackRadius) {
        super(pRangedAttackMob, pSpeedModifier, pAttackInterval, pAttackRadius);
        entity = ((AzkiEntity) pRangedAttackMob);
    ...
    public void checkAttack(Entity target) {
        if (this.attackDelay <= 0) {
            ...
            this.attackDelay = ticksUntilNextAttack;
        }
    }
}
