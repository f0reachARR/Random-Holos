...
public class NunnunKeepOnJumpingGoal extends Goal {
    private final NunnunEntity nunnunEntity;

    public NunnunKeepOnJumpingGoal(NunnunEntity nunnunEntity) {
    ...
    public boolean canUse() {
        return !this.nunnunEntity.isPassenger();
    }
    ...
    public void tick() {
        ...
        if (movecontrol instanceof NunnunMoveControl nunnun$nunnunmovecontrol) {
            nunnun$nunnunmovecontrol.setWantedMovement(1.0D);
        }
